...
const StatCard = ({ icon: Icon, label, value, trend, color, subtext, onClick }) => {
  ...
  return (
    <motion.div 
      whileHover={{ y: -2 }}
      onClick={onClick}
      className="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm hover:shadow-md transition-all cursor-pointer relative overflow-hidden"
    >
          ...
          <div className="bg-white/50 dark:bg-gray-800/20 backdrop-blur-sm rounded-3xl md:p-1">
            ...
            <AnimatePresence mode="popLayout">
                ...
                <motion.div 
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="flex flex-col items-center justify-center py-20 bg-white dark:bg-gray-800 rounded-2xl text-center shadow-sm"
                >
